...
// Assegure-se de que os caminhos de importação estão corretos
...
class _RegistroPetPageState extends State<RegistroPetPage> {
  // Uma lista de chaves de formulário, uma para cada etapa.
  ...
  // Lógica de continuação do Stepper (já estava correta)
    ...
    return Scaffold(
      ...
      body: Stepper(
        ...
        onStepCancel: _currentStep == 0
            ? null
            : () => setState(() => _currentStep -= 1),
        // Impede o toque direto nas etapas para forçar o uso dos botões
        onStepTapped: (step) {
          // Permite navegar para trás, mas não para a frente sem validar
  ...
  Widget _buildTextField(
    ...
    return TextFormField(
      ...
      decoration: InputDecoration(
        labelText: label,
        // ADICIONADO: Padding interno para dar espaço ao texto e corrigir o corte.
      ...
      children: [
        Expanded(
          child: _buildTextField(
            ...
            isRequired: false, // Tags não são obrigatórias
          ),
        ),
        IconButton(
          icon: const Icon(
